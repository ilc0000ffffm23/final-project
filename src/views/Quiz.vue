<template>
    <v-container fluid class="">
        <footer style="border-radius: 25px;">
            <p style="color: white; font-size: 24px; text-align: center; font-weight: bold;">Quiz Pro Quo</p>
            <p style="color: white; font-size: 12px; margin-left: 6px; text-align: center; font-weight: bold;">"I ask,
                you learn 😉"</p>
        </footer>
        <v-card color="blue-grey-darken-1" class="border-rounded mx-auto" style="width: 600px">
            <v-container>
            ...
            <v-form>
                <v-container>
                    ...
                    <form v-if="currentQuestion">
                        ...
                        <center>
                            <button class="reload text-white me-3" style="width: auto;" @click="reloadPage">Reset the
                                Quiz</button>
                        </center>
                    </form>
                </v-container>
